...
class KAVMAccount:
    ...
    def __init__(
        ...
        status: int = 0,
        key: str = '',
        apps_created: Optional[List[int]] = None,
        ...
        self._apps_created = apps_created
        self._apps_opted_in = apps_opted_in
        self._assets_created = assets_created
        self._assets_opted_in = assets_opted_in
