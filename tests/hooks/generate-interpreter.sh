...
KLLVM_INCLUDES="$(realpath ../../.build/usr/lib/kavm/kframework/include/kllvm/)"
...
# The blockchain-k-plugin hooks need libff, crypto++: both includes and the compiled shared object
LIBFF_LIB=$(realpath "../../.build/usr/lib/kavm/libff/lib/")
LIBFF_INCLUDE=$(realpath "../../.build/usr/lib/kavm/libff/include/")

CRIPTOPP_LIB=$(realpath "../../.build/usr/lib/kavm/cryptopp/lib/")
CRIPTOPP_INCLUDE=$(realpath "../../.build/usr/lib/kavm/cryptopp/include/")
...
llvm-kompile $CURDIR/kavm-hooks-tests-kompiled/partial.o main -- \
             ...
             -I"$CRIPTOPP_INCLUDE" -L"$CRIPTOPP_LIB"             \
